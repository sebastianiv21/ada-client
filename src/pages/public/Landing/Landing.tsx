  ...
  return (
    <Stack gap={5} className="mt-5">
      ...
      <TextImage image={medico}>
        ...
        <p>
          Brinda una interfaz user-friendly para los distintos usuarios con sus
          respectivas necesidades entre las cuales están la búsqueda, consulta y
      ...
      <TextImage image={microscopio}>
        ...
        <p>
          ...
          Mycobacterium tuberculosis (causante de la tuberculosis), pueden hacer
          que se produzca ADA en las zonas donde se encuentra en mayor cantidad.
          Esta prueba mide la cantidad de ADA en el líquido pleural, que permite
          establecer el diagnóstico de tuberculosis pleural.
        </p>
      </TextImage>
    </Stack>
  )
